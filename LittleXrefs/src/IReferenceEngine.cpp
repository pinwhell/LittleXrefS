...
IReferenceEngine::IReferenceEngine(CapstoneManager* _pCapstoneManager, uint16_t _abiRegBase)
...
{
	uintptr_t assemblyBase = (uintptr_t)LX::g_pLXrefs->getAssemblyEntry();
...
ArmReferenceEngine::ArmReferenceEngine(CapstoneManager* pCapstoneManager)
	: IReferenceEngine(pCapstoneManager, ARM_REG_R0)
{
}
//arm_reg::ARM_REG_R0
...
Arm64ReferenceEngine::Arm64ReferenceEngine(CapstoneManager* pCapstoneManager)
	: IReferenceEngine(pCapstoneManager, ARM64_REG_X0)
{
