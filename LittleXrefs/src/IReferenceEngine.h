...
struct IReferenceEngine
{
	...
	IReferenceEngine(CapstoneManager* pCapstoneManager, uint16_t abiRegBase);
...
struct ArmReferenceEngine : IReferenceEngine {
	ArmReferenceEngine(CapstoneManager* pCapstoneManager);
...
struct Arm64ReferenceEngine : IReferenceEngine {
	Arm64ReferenceEngine(CapstoneManager* pCapstoneManager);
